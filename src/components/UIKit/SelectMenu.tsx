    ...
    return (
        <Listbox value={selected} onChange={setSelected} >
            ...
            <div className="relative mt-3">
                <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-2 sm:py-1.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:focus-visible:outline-indigo-500 after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-zinc-800">
